...
<html>
	...
	<body>
		...
		<% 
			managerClient.deleteClientById(client);
		%>
		
		<p>Following client id has been deleted from database: </p>
		<p>ID Client: <jsp:getProperty name="client" property="id"></jsp:getProperty></p>
